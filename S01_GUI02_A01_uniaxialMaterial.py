...
def assign_values_to_model_args(model_args, unit_model, material_type) -> None:
    ...
    elif model_args[0] == 'Concrete01':
        fpc_Concrete01_input.value = model_args[2]
...
fpc_Concrete01_input = Text(value='-250.0', description="fpc:", continuous_update=False, layout=layout_var)
